...
const LOG_LOC = "./logs/log.txt"; // null | "./logs/log.txt";
...
logToFile(`Starging client v1.1 with API_SERVER: ${API_SERVER}\n`);
// Log middleware for /api requests
if (LOG_LOC !== null) {
    // Log requests
    app.use('/api', (req, res, next) => {
        fs_1.default.appendFileSync('./log.txt', `API request called: ${req.method} ${req.originalUrl} at ${new Date().toISOString()}\n`);
